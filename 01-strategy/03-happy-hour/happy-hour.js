...
if (paleAlePrice==4.0) { console.log("paleAlePrice ok") } else { console.log("paleAlePrice ko " + paleAlePrice) }
if (chouffePrice==2.7) { console.log("chouffePrice ok") } else { console.log("chouffePrice ko " + chouffePrice) }
if (ipaPrice==3.75) { console.log("ipaPrice ok") } else { console.log("ipaPrice ko " + ipaPrice) }